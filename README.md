...
* The original package name 'com.security.cors-config' is invalid and this project uses 'com.security.cors_config' instead.

# Getting Started

### For CORS Testing:
Add to ``HttpSecurity`` class in ``SecurityFilterChain`` 
